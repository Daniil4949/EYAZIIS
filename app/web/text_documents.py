...
async def get_text_documents(
    text_document_service: TextDocumentService = get_dependency(
...
@inject
async def get_text_document_by_name(
    document_name: str,
    text_document_service: TextDocumentService = get_dependency(
        "text_document_service"
    ),
):
    return await text_document_service.get_document(
...
async def delete_text_document(
    ...
    return await text_document_service.delete_document(
        document_name=document_name
    )
